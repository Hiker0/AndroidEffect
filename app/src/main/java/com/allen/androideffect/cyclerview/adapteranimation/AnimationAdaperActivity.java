package com.allen.androideffect.cyclerview.adapteranimation;
...
public class AnimationAdaperActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button startButton = (Button) this.findViewById(R.id.btn_start);
        startButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                recycler.setAdapter(new SlideInLeftAnimatorAdapter(adapter,recycler));
            }
        });
